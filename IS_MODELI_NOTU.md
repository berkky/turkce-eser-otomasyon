...
4. Onaylı tam eser plan/onay/kuyruk kapısı (Adım 31 — tamamlandı)
5. Final release kalite kapısı (Adım 32 — tamamlandı)
6. Lisans/hak yönetim modülü
7. Telaffuz sözlüğü ve normalizasyon (Adım 28 ile başlandı)
8. Bulut dağıtım ve kimlik doğrulama (isteğe bağlı)
9. Teslim ZIP paketi (Adım 33)
