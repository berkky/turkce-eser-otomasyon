...
Write-Host "--- ELEVENLABS FORCED ALIGNMENT (Adim 30) ---"
...
if ($DemoFixture) {
    ...
    Write-Host "Mod: GERCEK API (acik onayli - forced alignment)"
    Write-Host "Uyari: Gercek preview MP3 + preview-input.txt gerekir"
} else {
