...
function Write-TestBaslik([string]$Anahtar) {
    $map = @{
        ...
        'adim34' = '--- ADIM 34 TTS A/B LABORATUVARI DOĞRULAMA ---'
        'adim34Derleme' = '--- ADIM 34 MAVEN DERLEME ---'
        'adim34Dogrulama' = '--- ADIM 34 MOCK/HTTP DOĞRULAMA ---'
        'adim33Regression' = '--- ADIM 21-33 REGRESSION ---'
        'adim34SecretScan' = '--- ADIM 34 SECRET SCAN ---'
